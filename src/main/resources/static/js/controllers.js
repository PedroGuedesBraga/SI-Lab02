...
angular.module("sistemaDeMusica").controller("sistemaController", function($scope, $http){
	...
	$http({method: 'GET', url:'http://localhost:8080/artistas'})
	...
	$scope.cadastrarUsuario = function(usuario){
		$http({method:'POST', url:'http://localhost:8080/usuarios/cadastro', data: usuario})
		.then(function(response){
	...
	$scope.logarUsuario = function(usuario){
		$http({method:'POST', url: 'http://localhost:8080/usuarios/login', data: usuario})
		.then(function(response){
	...
	$scope.fillArtistasFavoritos = function(){
		if($scope.usuarioLogadoStatus){
			$http({method:'GET', url: 'http://localhost:8080/usuarios/favoritos/'+$scope.usuarioLogado.id})
			.then(function(response){
	...
	$scope.addArtista = function(artista){
		if(existeArtista(artista)){
			...
			$http({method: 'POST', url: 'http://localhost:8080/artistas', data: artista})
